          ...
          <div className="rounded-[10px] bg-[#1A2754]/60 px-4 shadow py-3 mt-16 relative z-50">
            <form>
              ...
              <div className="buttons">
                <button type="submit" className='w-full py-2 leading-[30px] rounded-[5px] mb-4 text-center font-medium text-white text-[15px] bg-[#40D260]/70'>Justify your negligence</button>
                <button type='button' className='w-full py-2 leading-[30px] rounded-[5px] mb-4 text-center font-medium text-white text-[15px] bg-gradient-to-r from-[#AC62E6] to-[#9755CB]'>Random</button>
              </div>
            </form>
            ...
            <div className="mt-4">
              ...
              <div className="rounded bg-[#D9D9D9]/20 relative px-3 py-6">
                <div className="absolute flex items-center justify-center bg-white rounded-full icon top-3 h-7 w-7 right-3">
